...
with open("2017_5_5_12_19_55_block101_t1.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
...
with open("2017_5_5_12_19_55_block102_t2.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
    this_time = float(words[0]) + float(words[1]) / 1000000
...
with open("2017_5_5_12_19_54_block4_t3.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
    this_time = float(words[0]) + float(words[1]) / 1000000
...
with open("2017_5_5_12_19_54_block5_t4.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
...
with open("2017_5_5_12_19_55_block105_t5.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
    this_time = float(words[0]) + float(words[1]) / 1000000
...
with open("2017_5_5_12_19_7_block100_tRX1.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
...
with open("2017_5_5_12_19_7_block100_tRX2.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
    this_time = float(words[0]) + float(words[1]) / 1000000
