...
with open("2017_5_5_10_16_18_block101_t1.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
...
with open("2017_5_5_10_16_18_block102_t2.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
    this_time = float(words[0]) + float(words[1]) / 1000000
...
with open("2017_5_5_10_16_18_block4_t3.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
    this_time = float(words[0]) + float(words[1]) / 1000000
...
with open("2017_5_5_10_16_18_block5_t4.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
...
with open("2017_5_5_10_16_18_block105_t5.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
    this_time = float(words[0]) + float(words[1]) / 1000000
...
with open("2017_5_5_10_16_1_block100_tRX1.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
...
with open("2017_5_5_10_16_1_block100_tRX2.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
    this_time = float(words[0]) + float(words[1]) / 1000000
...
with open("500_400k_result.txt", "w") as f:
  f.write("tao_12_500_mean = \t\t")
