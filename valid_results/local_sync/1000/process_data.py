...
with open("2017_5_3_16_1_27_block101_t1.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
...
with open("2017_5_3_16_1_27_block102_t2.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
    this_time = float(words[0]) + float(words[1]) / 1000000
...
with open("2017_5_3_16_1_27_block4_t3.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
    this_time = float(words[0]) + float(words[1]) / 1000000
...
with open("2017_5_3_16_1_27_block5_t4.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
...
with open("2017_5_3_16_1_27_block105_t5.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
    this_time = float(words[0]) + float(words[1]) / 1000000
...
with open("2017_5_3_15_59_54_block100_tRX1.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
...
with open("2017_5_3_15_59_54_block100_tRX2.txt") as file:
  data = file.readlines()
  for line in data:
    words = line.split()
    this_time = float(words[0]) + float(words[1]) / 1000000
...
tao_12_std = numpy.mean(tao12_arr)
tao_23_std = numpy.mean(tao23_arr)
tao_34_std = numpy.mean(tao34_arr)
tao_35_std = numpy.mean(tao35_arr)
tao_15_std = numpy.mean(tao15_arr)
tao_3RX1_std = numpy.mean(tao3RX1_arr)
tao_cs_std = numpy.mean(taocs_arr)
tao_RX1RX2_std = numpy.mean(taoRX1RX2_arr)
tao_5RX2_std = numpy.mean(tao5RX2_arr)
...
with open("1000_result.txt", "w") as f:
  f.write("tao_12 \t\t")
