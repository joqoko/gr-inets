...
# Author: PWA
# Generated: Wed Feb  1 06:51:45 2017
##################################################
...
class Test_framing_cpp(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.inets_framing_0 = inets.framing(1, 17, 1, 8, 1, frame_index, 1, destination_address, 1, source_address, 1, 318, 2, 524, 2, 2, 1, 1, 567)
